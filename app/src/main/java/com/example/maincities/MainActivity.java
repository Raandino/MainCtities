        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null
            ...
            public void onResponse(JSONObject response) {
                ...
                /*------------------RESPUESTA JSON A LOS ARRAYS------------------*/
                    ...
                    JSONArray jsonMain = response.getJSONArray("main");//Respuesta a arreglo json "main"
                    ...
                    String main =  weather.getString("main");//main es el tiempo del lugar
                    String description =  weather.getString("description");//description es la descrip del tiempo
                    tiempo.append(main);///cambia el valor del TextView

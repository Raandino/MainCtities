...
public class Managua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_managua);
    ...
    public void jsonParse() {//metodo jasonParse es donde se hace la consulta a la api de open wheather
        ...
        String url = "http://api.openweathermap.org/data/2.5/weather?q=managua&APPID=35089672db223f72240e37f9e0753f51";//url del api de open wheather
